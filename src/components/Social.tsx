    ...
    return (
        <>
            ...
            <div className="mt-10 rounded bg-white h-[40vh] mx-10 px-8">
                    <h3 className="text-center py-5 text-2xl font-semibold font-sans">Social Accounts</h3>

                    <div className='text-right'>
                    <button type='submit' className='bg-green-700 rounded text-center py-2 text-sm px-3 font-medium font-sans text-white'>Add Social Account</button>
